 ...
 * @LastEditors: web.王晓冬
 * @LastEditTime: 2020-11-03 23:42:19
...
export default {
  ...
  methods: {
    ...
    onDragging(ev) {
      ...
      let diff = 0;
      diff = (ev.offsetX / ev.target.clientWidth) * 100;
      this.playRatio = ev.offsetX / ev.target.clientWidth;
      console.log(diff, this.playRatio);
      // this.playRatio = diff;
      // console.log(diff);
