 ...
 * @LastEditors: web.王晓冬
 * @LastEditTime: 2020-11-03 23:12:17
...
export default {
  ...
  methods: {
    ...
    onButtonDown(ev) {
      ...
      this.playRatio = ((ev.offsetX / ev.target.clientWidth) * 100).toFixed(4);
      this.dVideo.currentTime = this.dVideo.duration * this.playRatio;
      console.log(((ev.offsetX / ev.target.clientWidth) * 100).toFixed(4));
      console.dir(ev.target.clientWidth);
    },
    // 播放速度
    playbackRates() {},
